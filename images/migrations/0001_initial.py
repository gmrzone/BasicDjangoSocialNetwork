    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('image', models.ImageField(upload_to='<function get_username at 0x03D3E6E8>/%Y/%m/%d/')),
                ...
                ('users_like', models.ManyToManyField(blank=True, related_name='image_likes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
